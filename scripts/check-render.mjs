...
try {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    const hub = readFileSync(p2('components', 'mirror', 'timeline', 'MomentHub.tsx'), 'utf8');
    ...
    r.check(/is-inline/.test(hub) && /wc-hub-inline-head/.test(hub),
      'the operational editor uses a compact inline head, not a large cover');
